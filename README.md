...
1. Save the app logo image as `happie-logo.png` in the `assets/` folder
2. The image should be a PNG format for best quality
3. The app expects the logo at `assets/happie-logo.png`
...
- **Feel**: Clean, intuitive, and user-focused
