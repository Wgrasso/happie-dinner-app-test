 ...
 */
// Feature flag — inactive reminders were turning into noise so they're off.
// Flip this back to true to re-enable without touching any call sites.
const INACTIVE_REMINDERS_ENABLED = false;

export const checkAndSendInactiveReminder = async () => {
  if (!INACTIVE_REMINDERS_ENABLED) return { sent: false, reason: 'disabled' };
